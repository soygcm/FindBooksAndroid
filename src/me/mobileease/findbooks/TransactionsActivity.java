...
public class TransactionsActivity extends ActionBarActivity implements OnItemClickListener {
	...
	private void getTransactions() {
		...
		query.findInBackground(new FindCallback<ParseObject>() {
			...
			public void done(List<ParseObject> list, ParseException e) {
				if(e == null){
					adapterTransactions = new TransactionAdapter(TransactionsActivity.this, list);
	...
	/**
     * BookOffer: Titulo, Subtitulo, autores, foto
     * MyBook: FotoOferta, Estado, Descripción, precio, moneda, binding
     * User-Other: Usuario, telefono, etc.
     */
